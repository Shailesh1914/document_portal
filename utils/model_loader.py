...
class ModelLoader:
    ...
    def _validate_env(self):
        """Validate necessary environmnet variable. Ensure API keys exists"""
        ...
        log.info("Environmnet variables validated", available_keys=[k for k in self.api_keys if self.api_keys[k]])
    ...
    def load_llm(self):
        ...
        max_tokens = llm_config.get("max_output_token", 2048)
