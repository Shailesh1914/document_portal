...
class DocumentIngestion:
    ...
    def __init__(self, base_dir: str = "data/document_compare", session_id=None):
        ...
        self.log.info("DocumentComparator intitiated", session_path = str(self.session_path))
    ...
    def combine_documents(self) -> str:
        """
        Combine content of all PDFs in session folder into single string
        """
        try:
            doc_parts = []
    ...
    def clean_old_session(self, keep_latest: int = 3):
        """
        Optional method to delete older session folders, keeping only latest N    
        """
        ...
        try:
            ...
            self.log.error("Error cleaning old sessions", sys)